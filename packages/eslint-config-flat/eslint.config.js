...
// @ts-check
/// <reference path="eslint-plugin-next.d.ts" />
/// <reference path="eslint-plugin-react-hooks.d.ts" />
/// <reference path="eslint-plugin-react.d.ts" />
/// <reference path="eslint-plugin-sort-keys-fix.d.ts" />
